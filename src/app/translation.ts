...
export const translations = {
    ...
    fr: {
      main: {
        ...
        transit : "Découvrez des services de transport en commun fiables et efficaces conçus pour simplifier votre voyage. Qu'il s'agisse de transports en commun, de navettes privées ou d'itinéraires long-courriers, notre plateforme vous connecte à des options sûres et accessibles pour tous vos besoins de déplacement.",
        consignation : "notre consignation expert et emploi de notre domaine je veux fait tout  ededxd fdeddse ect..",
        }
    },
  };
